      ...
      switch (state) {
        case 0:
          ...
          if (response.substring(0, 3).equals("100")) {
            System.out.print("You're the 1st client to connect – ");
            System.out.print("you must wait for the 2nd client before you can begin messaging.\n");
            state = 1;
          } else if (response.substring(0, 3).equals("200")) {
            System.out.print("You're the 2nd client to connect –");
            System.out.print("you must wait for the 1st client to send a message.\n");
            state = 2;
          }
